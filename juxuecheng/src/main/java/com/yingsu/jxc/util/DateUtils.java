...
// 取值范围：就是临界点包不包含等于
    ...
    public static String getTime(String date) {
        String time_temstamp = date.substring(0, 10);
        return time_temstamp;
    }
    /**
     * 获得当前的日期毫秒
     *
...
/**
 ...
 10      */
    ...
    public static Timestamp getTimeStamp(String dateStr) {
        ...
        try {
            Date date = LONG_DATE_FORMAT.parse(dateStr);
    ...
    // 获取几个月后日期
    public static String getMonthDate(int term){
    ...
    // 获取今天是本月的第几天
    public static String whichDayOfMonth() {
        Calendar calendar = Calendar.getInstance();
